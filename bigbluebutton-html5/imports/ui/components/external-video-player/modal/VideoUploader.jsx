...
function VideoUploader(props) {
  ...
  const onFormSubmit = (e) => {
    ...
    axios
      .post('https://bbb2.pressply.site/upload/video', formData, config)
      .then((res) => {
        setPercent(100);
  ...
  const setExternalVideoWatch = (e, vidurl) => {
    ...
    console.log(`https://bbb2.pressply.site/${vidurl}`);
  };
    ...
    <VideoUploaderTag className="video-uploader">
      <form onSubmit={onFormSubmit} className="video-uploader-form">
        ...
        <div className="up-button">
          <button type="submit" disabled={percent > 0}>
            Upload
          </button>
        </div>
      </form>
      ...
      {percent === 100 && fileName && (
        <div className="video-pp">
          ...
          <div className="up-button">
            <button
              type="button"
              onClick={(e) => setExternalVideoWatch(e, url)}
            >
              Share Video
            </button>
          </div>
